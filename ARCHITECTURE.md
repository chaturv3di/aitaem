...
metric:
  ...
  timestamp_col: event_date  # Optional: column used for time_window filtering
```
...
class MetricSpec:
    ...
    timestamp_col: str | None  # Date/timestamp column for time_window filtering (None = no filtering)
